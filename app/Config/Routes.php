...
//$routes->resource('users'); // Rutas para el recurso "users"

$routes->get('users', 'Usersroles::index'); // Ruta para obtener todos los usuarios
$routes->get('users/(:num)', 'Usersroles::show/$1'); // Ruta para obtener un usuario específico por ID
